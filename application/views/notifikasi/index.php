									...
									<table id="tblData" class="table table-bordered table-striped">
										<thead>
											<tr>
												...
												<th>Nama</th>
												<th>Jabatan</th>
												<th>Tanggal Kenaikan Jabatan</th>
												<th>Aksi</th>
											</tr>
										</thead>
										<tbody>
	...
	<footer class="mt-auto">
		<div class="content__boxed">
			<div class="content__wrap py-3 py-md-1 d-flex flex-column flex-md-row align-items-md-center">
				<div class="text-nowrap mb-4 mb-md-0">Copyright &copy; 2022 <a href="#" class="ms-1 btn-link fw-bold">SIMTA Kab Mimika</a></div>
			...
			<form id="edit">
				...
				<div class="modal-body">
					<div class="card-body">
						...
						<br>
						<div class="form-group">
							<label for="tgl_kenaikan_pangkat">Tanggal Kenaikan Pangkat</label>
							<input name="tgl_kenaikan_pangkat" type="date" class="form-control" id="tgl_kenaikan_pangkat">
						</div>
					</div>
					<!-- /.card-body -->
				</div>
...
<div class="modal fade" id="modal-reset">
	<div class="modal-dialog modal-sm">
		<div class="modal-content">
			<form id="reset">
				<div class="modal-header">
					<h4 class="modal-title">Apakah Anda Ingin Mereset Tanggal Kenaikan Jabatan ?</h4>
					<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
					</button>
				</div>
				<div class="modal-body">
					<div class="card-body">
						...
						<!-- <div class="form-group">
					<label for="tgl_kenaikan_pangkat">Tanggal Kenaikan Pangkat</label>
					<input name="tgl_kenaikan_pangkat_reset" type="date" class="form-control" id="tgl_kenaikan_pangkat_reset" >
					</div> -->
					</div>
					<!-- /.card-body -->
				</div>
	...
	function edit(nip) {
		$.ajax({
			...
			success: function(data) {
				...
				$("#edit").find("input[name=tgl_kenaikan_pangkat]").val(json.tgl_kenaikan_pangkat);
